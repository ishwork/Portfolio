...
export const experiences: Experience[] = [
  {
    ...
    description: {
      ...
      2: 'Implemented frontend UI testing and end-to-end tests using React Testing Library and Playwright to ensure application quality.',
      3: 'Worked on migrating the Next.js project from pages router to app router and website redesign.',
      4: 'Worked on implementing login feature in the website using AWS Cognito service and NextAuth.js.',
      5: 'Created and deployed cloud infrastructures using AWS CDK.',
      6: 'Customized and extended the Labrador CMS used by news editors and helping editorial workflows.',
